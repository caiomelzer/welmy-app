...
class _ScanState extends State<BalancaPage> {
  ...
  initState() {
    ...
    NetworkInterface.list(includeLoopback: false, type: InternetAddressType.any)
      ...
      if (_networkBalance) _listBalance(context);
      setState(() {});
    });
  }
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Text('Configurando sua Balança: ',
                                  style: TextStyle(
                            ...
                            Padding(
                              ...
                              child:
                                  Text('1 - Nas configurações do seu celular;'),
                            ),
                            Padding(
                              padding: const EdgeInsets.fromLTRB(0, 0, 0, 7),
                              child: Text(
                                  '2 - Conectar-se na rede com o nome "Balança_XXXX", onde XXXX é um número;'),
                            ),
                            Padding(
                              padding: const EdgeInsets.fromLTRB(0, 0, 0, 7),
                              child: Text(
                                  '3 - Inserir o nome da Rede e senha que a Balança irá se conectar;'),
                            ),
                            Padding(
                              padding: const EdgeInsets.fromLTRB(0, 0, 0, 7),
                            ...
                            Padding(
                              ...
                              child: Text(
                                  '5 - Volte a rede Wifi que você estava utilizando antes;'),
                            ),
                          ],
                        ),
                      ),
